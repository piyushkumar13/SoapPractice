 ...
 * generated in the com.lifetech.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetMessageResponse_QNAME = new QName("http://service.lifetech.com/", "getMessageResponse");
    private final static QName _GetMessage_QNAME = new QName("http://service.lifetech.com/", "getMessage");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.lifetech.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.lifetech.com/", name = "getMessageResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.lifetech.com/", name = "getMessage")
